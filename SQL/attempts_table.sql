...
`Policy_Server_Response_Setup_time`     decimal(10,0) unsigned NOT NULL DEFAULT '0' COMMENT '8',
`Receipt_of_Alerting_ProcProg_Setup_Time`       decimal(10,0) unsigned NOT NULL DEFAULT '0' COMMENT '9',
`Disconnect_Date` varchar(10) NOT NULL DEFAULT '''''' COMMENT '105',
`Disconnect_Time`       varchar(10) NOT NULL DEFAULT '''''' COMMENT '10',
`Disconnect_to_Completion_of_Call_Time` decimal(10,0) unsigned NOT NULL DEFAULT '0' COMMENT '11',
`Call_Disconnect_Reason`        decimal(3,0) unsigned NOT NULL DEFAULT '0' COMMENT '12',
...
`Script_Log_Data`       varchar(95) NOT NULL DEFAULT '''''' COMMENT '40',
...
`Disconnect_Initiator`  double(1,0) unsigned NOT NULL DEFAULT '0' COMMENT '57',
...
`Ingress_Codec_Type`    varchar(6) NOT NULL DEFAULT '''''' COMMENT '69',
...
`Egress_Codec_Type`     varchar(6) NOT NULL DEFAULT '''''' COMMENT '70',
...
`Ingress_RTP_Packetization_Time`        decimal(3,0) unsigned NOT NULL DEFAULT '0' COMMENT '71',
`GSX_NBS_Call_ID`       varchar(12) NOT NULL DEFAULT '''''' COMMENT '72',
`Terminated_with_Script`        binary(1) NOT NULL DEFAULT '0' COMMENT '73',
`Originator_Echo_Cancellation`  decimal(1,0) unsigned NOT NULL DEFAULT '0' COMMENT '74',
`Terminator_Echo_Cancellation`  decimal(1,0) unsigned NOT NULL DEFAULT '0' COMMENT '75',
...
`Call_Disconnect_Reason_TX_Ingress`     decimal(3,0) unsigned NOT NULL DEFAULT '0' COMMENT '111',
`Call_Disconnect_Reason_TX_Egress`      decimal(3,0) unsigned NOT NULL DEFAULT '0' COMMENT '112',
...
`Egress_RTP_Packetization_Time` decimal(3,0) unsigned NOT NULL DEFAULT '0' COMMENT '134',
...
`Final_ATT_Indicator`   tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '146',
...
`Extra_Disconnect_Reason`       decimal(4,0) unsigned NOT NULL DEFAULT '0' COMMENT '150',
...
`Call_Disconnect_Location`      decimal(2,0) unsigned NOT NULL DEFAULT '0' COMMENT '160',
`Call_Disconnect_Location_Tx_Ingress`   decimal(2,0) unsigned NOT NULL DEFAULT '0' COMMENT '161',
`Call_Disconnect_Location_Tx_Egress`    decimal(2,0) unsigned NOT NULL DEFAULT '0' COMMENT '162',
